...
namespace Pyke.Networking.Http
{
    ...
    public interface ILeagueRequestHandler
    {
        ...
        /// <summary>
        /// Creates and sends a new <see cref="HttpRequestMessage"/> and deserializes the <see cref="HttpResponseMessage"/>'s content (json) as <typeparamref name="TResponse"/> into <see cref="RequestResponse{TResponseType}"/>.
        /// </summary>
        /// <typeparam name="TRequest">The object to serialize into the body.</typeparam>
        /// <typeparam name="TResponse">The object to deserialize the response into.</typeparam>
        /// <param name="httpMethod">The <see cref="HttpMethod"/>/</param>
        ...
        /// <param name="body">The request's body.</param>
        /// <returns>The deserialized response.</returns>
        Task<RequestResponse<TResponse>> HttpRequest<TRequest, TResponse>(HttpMethod httpMethod, string relativeUrl, IEnumerable<string> queryParameters, TRequest body);
